...
dataset = FingerprintDataset(root_dir=train_folder, csv_file='list.csv', img_width=opt.img_size,
                             img_height=opt.img_size,
                             pad_width=0, RBS=True)
...
for epoch in range(opt.n_epochs):
    for i, (_, imgs) in enumerate(dataloader):
